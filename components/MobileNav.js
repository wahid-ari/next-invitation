  ...
  return (
    <svg className={className} viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        clipRule='evenodd'
        d='M7.27002 13.9519L8.8627 8.8627L13.9519 7.27002L12.3593 12.3593L7.27002 13.9519Z'
        stroke='url(#paint0_linear_138_30)'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
      />
      <circle
        ...
        cy='10.611'
        r='9.61098'
        stroke='url(#paint1_linear_138_30)'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
      />
        ...
        <div className='scrollbar-thumb-rounded mx-2 flex items-center justify-between space-x-3 overflow-auto rounded-t-lg bg-black/90 px-4 pb-2 pt-2 backdrop-blur scrollbar scrollbar-thin scrollbar-thumb-neutral-900 sm:mx-auto sm:max-w-lg sm:pb-3'>
          ...
          >
            <LinkScroll
              ...
              className={`animation-hover 
            ${activeLink === 'ripple' ? ' animation-active bg-gradient-to-br from-sky-500 via-green-500 to-yellow-500 bg-clip-text text-transparent' : 'bg-gradient-to-b from-white to-[#AAAAAA] bg-clip-text text-transparent'} 
            flex cursor-pointer flex-col items-center gap-2 px-0.5 py-1 text-sm font-bold transition-all`}
            >
          ...
          >
            <LinkScroll
              ...
              className={`animation-hover 
            ${activeLink === 'gridd' ? 'animation-active bg-gradient-to-br from-sky-500 via-green-500 to-yellow-500 bg-clip-text text-transparent' : 'bg-gradient-to-b from-white to-[#AAAAAA] bg-clip-text text-transparent'} 
            flex cursor-pointer flex-col items-center gap-2 px-0.5 py-1 text-sm font-bold transition-all`}
            >

      ...
      <form className='mt-8' onSubmit={onSubmit}>
        <div className='rotate-border rotate-border-1 relative flex h-full w-full items-center justify-center overflow-hidden rounded-lg bg-transparent p-0.5'>
          <input
            ...
            placeholder='Name'
            required
            className='relative z-10 flex h-full w-full rounded-md border border-neutral-600 bg-neutral-900 px-3 py-2 text-sm placeholder:text-neutral-400 focus-visible:border-neutral-600 focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-1 focus-visible:ring-offset-neutral-900'
          />
        </div>
        <div className='rotate-border rotate-border-2 relative my-4 flex h-full w-full items-center justify-center overflow-hidden rounded-lg bg-transparent p-0.5'>
          <textarea
            ...
            placeholder='Comment'
            required
            className='z-10 flex min-h-[100px] w-full rounded-md border border-neutral-600 bg-neutral-900 px-3 py-2 text-sm placeholder:text-neutral-400 focus-visible:border-neutral-600 focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-1 focus-visible:ring-offset-neutral-900'
          />
        </div>

    ...
    <div className='relative min-h-screen bg-black'>
      <div className='pointer-events-none absolute inset-x-0 bottom-0 top-0 z-0 flex justify-center'>
        <div className='grid h-full min-h-screen w-full grid-cols-3 gap-3.5 px-4 sm:grid-cols-5'>
          ...
          <div className='h-full w-full rounded-md bg-gradient-to-br from-green-600/20 via-yellow-600/20 to-blue-600/20 px-[0.5px]'>
            <div className='flex h-full w-full items-center justify-center bg-black'></div>
          </div>
        ...
        <form className='mt-' onSubmit={onSubmit}>
          ...
          <div className='rotate-border rotate-border-2 relative my-4 flex h-full w-full items-center justify-center overflow-hidden rounded-lg bg-transparent p-0.5'>
            <textarea
              ...
              placeholder='Comment'
              required
              className='z-10 flex min-h-[80px] w-full rounded-md border border-neutral-600 bg-black px-3 py-2 text-sm placeholder:text-neutral-400 focus-visible:border-neutral-600 focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-1 focus-visible:ring-offset-neutral-900'
            />
          </div>
...
function BorderFrame({ children }) {
  return (
    <div className='relative'>
      <div className='absolute -inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-yellow-500 to-transparent sm:-inset-x-12 md:-inset-x-16' />
      <div
        style={{
      ...
      />
      <div className='absolute -inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-sky-500 to-transparent sm:-inset-x-12 md:-inset-x-16' />
      <div
        style={{
          backgroundImage: `linear-gradient(to right, transparent, rgb(255 255 255 / 0.25) 24px, rgb(255 255 255 / 0.25) calc(100% - 24px), transparent)`,
        }}
